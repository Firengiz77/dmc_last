...
<section>
        <div class="register-form">
            <div class="container">
                ...
                <form action="{{ route('add_media') }}" method="post" class="mt-5">
                    @csrf
                    ...
                    <div class="phone">
                        <span class="countrycode">+994</span><input type="text" id="phone" name="tel" 
                            placeholder="(__) ___-__-__" />
                    </div>
                    <textarea name="media_qurum"  class="form-control"  id="" style="margin-bottom: 20px">{{ __('media_qurum') }}</textarea>
                    <textarea name="qeyd" class="form-control"  id="" style="margin-bottom: 20px">{{ __('qeyd') }}</textarea>
