...
@section('title'){{$meta->sponsor_title}}@endsection
@section('meta_desc'){{$meta->sponsor_desc}}@endsection
@section('meta_keyw'){{$meta->sponsor_keyw}}@endsection
...
<section>
        <div class="register-form">
            <div class="container">
                ...
                <form action="{{ route('create_sponsor_form') }}" method="post" class="mt-5">
                    @csrf
                    <input type="text" class="form-control"  name="name" placeholder="{{ __('your_name')}}" >
                    <input type="text" class="form-control" name="surname"  placeholder="{{ __('your_surname')}}" >
                    <input type="email" class="form-control"name="email"   placeholder="{{ __('your_email')}}" >
                    <div class="phone">
                        <span class="countrycode">+994</span><input type="text" id="phone" name="phone" 
                            placeholder="(__) ___-__-__" />
                    </div>
                    <input type="text" class="form-control"  name="work" placeholder="{{ __('your_company')}}" >
                    <input type="text" class="form-control" placeholder="{{ __('your_profession')}}"  name="profession" >
                    <div class="practice">
                        <select name="experience" id="cars" class="form-control" placeholder="{{__('your_work')}}">
                            <option value="" disabled selected hidden> {{__('sponsor')}} </option>

                            @foreach($sponsors as $sponsor)
                            <option value="{{ $sponsor->title}}">{{ $sponsor->title }}</option>
