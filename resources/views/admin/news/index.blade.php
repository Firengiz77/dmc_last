...
@section('container')
          ...
          <div class="content-wrapper">
            ...
            <div style="display: flex;align-items: baseline;flex-direction: row;justify-content: space-between;">
              ...
              <a class="btn btn-success" href="{{ route('admin.news_show') }}"> {{ __('add_blog') }} </a>
                ...
                <div class="table-responsive text-nowrap">
                 ...
                 @foreach($all_news as $key => $news )
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('admin.news_edit',$news->id) }}" class="btn btn-outline-primary">{{ __('edit') }}</a>
                          <a href="{{ route('admin.news_delete',$news->id) }}" class="btn btn-outline-danger delete-confirm">{{ __('delete') }}</a>
                        </td>
                      </tr>
