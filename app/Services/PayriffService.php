...
class PayriffService
{
        ...
        return 
            Http::withHeaders([
              'Content-Type' => 'application/json',
                "Authorization" => '5D035B88FF0F4562878F4E3B4B0350DC',
            ...
            // Http::withHeaders([
            //     "Authorization" => '78CA79203C044DBBA3CCB46C0B73A8FD',
            // ])->post($this->baseUrl.$method, [ 
            //     "body" => $body,
    ...
    public function createOrder($amount, $description = null, $currencyType = 'AZN',  $language = 'AZ', $approveURL = null, $cancelURL = null, $declineURL = null)
    {
        ...
        $body = [
            "amount" => $amount,
            "approveURL"=> $approveURL,  //Bunlar olmalidi route formasinda var idi
            "cancelURL" => $cancelURL,
