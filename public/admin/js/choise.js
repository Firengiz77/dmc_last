    ...
    return (function (e) {
        ...
        function (e, t, i) {
            ...
            t.generateId = function (e, t) {
                var i =
                    e.id ||
                    (e.name && "".concat(e.name, "-").concat(o(2))) ||
                    o(4);
                return (
                    (i = i.replace(/(:|\.|\[|\]|,)/g, "")),
                    (i = "".concat(t, "-").concat(i))
            ...
            var _ = (function () {
                function e() {
                    ...
                    this.config = o.default.all(
                        [a.DEFAULT_CONFIG, e.userDefaults, i],
                        {
                    ...
                    return l
                        ? ((this._isTextElement = "text" === l.type),
                          ...
                          this._isTextElement
                              ...
                              : this._isSelectElement &&
                                (this.passedElement = new s.WrappedSelect({
                                    element: l,
                                    classNames: this.config.classNames,
                                })),
                          this.passedElement
                              ? (!0 === this.config.shouldSortItems &&
                                ...
                                (this._direction =
                                    this.passedElement.element.getAttribute(
                                        "dir"
                                    ) || "ltr"),
                                ...
                                void this.init())
                              : console.error(
                                    "Passed element was of an invalid type"
                                ))
                        : console.error(
                ...
                return (
                    ...
                    (i = [
                            ...
                            value: function (e) {
                                ...
                                return (
                                    this._store.dispatch(
                                        (0, u.highlightItem)(i, !0)
                                    ),
                                    t &&
                                        this.passedElement.triggerEvent(
                                            a.EVENTS.highlightItem,
                                            {
                                                id: i,
                                                value: s,
                                                label: l,
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e =
                                        ...
                                        void 0 !== arguments[0] &&
                                        arguments[0],
                                    t = this._store.activeItems.reduce(
                                        function (t, i) {
                                            var n = e ? i.value : i;
                                            return t.push(n), t;
                                        },
                        ...
                        },
                        {
                            ...
                            value: function () {
                                return (
                                    this._store.dispatch((0, d.clearAll)()),
                                    this
                                );
                            },
                        },
                                    ...
                                    if (t && i) {
                                        ...
                                        o.length
                                            ? (e._handleLoadingState(!1),
                                              ...
                                              e._setLoading(!1),
                                              e._isSelectOneElement &&
                                                  e._selectPlaceholderChoice())
                                            : e._handleLoadingState(!1);
                                    }
                                };
                            },
                                ...
                                if (i || this._isSelectOneElement) {
                                    ...
                                    l &&
                                        ((0, p.isScrolledIntoView)(
                                            ...
                                            this.choiceList.scrollToChoice(
                                                l,
                                                u
                                            ),
                            ...
                            value: function (e) {
                                ...
                                if (
                                    (this.choiceList.element.contains(t) &&
                                        (0, p.isIE11)() &&
                                        (this._isScrollingOnIe = !0),
                                    this.containerOuter.element.contains(t) &&
                                        t !== this.input.element)
                                ) {
                                    var n = this._store.activeItems,
                                        o = i,
                                        r = (0, p.findAncestorByAttrName)(
                                            t,
                                            "data-button"
                                        ),
                                        s = (0, p.findAncestorByAttrName)(
                                            t,
                                            "data-item"
                                        ),
                                        a = (0, p.findAncestorByAttrName)(
                                            t,
                                            "data-choice"
                                        );
                                    r
                                        ? this._handleButtonAction(n, r)
                                        : s
                                        ? this._handleItemAction(n, s, o)
                                        : a && this._handleChoiceAction(n, a),
                                        e.preventDefault();
                                }
                            },
                        },
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                if (
                                    ...
                                    var n = this._store.activeItems.some(
                                        function (e) {
                                            return e.highlighted;
                                        }
                                    );
                            ...
                            value: function () {
                                ...
                                if (i.length) {
                                    ...
                                    Array.from(
                                        ...
                                        t.classList.remove(
                                            e.config.classNames.highlightedState
                                        ),
                                            t.setAttribute(
                                                "aria-selected",
                                                "false"
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                e &&
                                    ...
                                    (this.config.templates = (0, o.default)(
                                        c.TEMPLATES,
                                        t
                                    ));
                            },
      ...
      \***********************************/
                        /*! no static exports found */ function (e, t, i) {
                            var n = i(
                                    /*! ./bitap_score */ "./src/bitap/bitap_score.js"
                                ),
                                o = i(
      ...
      \****************************/
                        /*! no static exports found */ function (e, t, i) {
                            ...
                            var o = i(
                                ...
                                r = i(
                                    /*! ./bitap_search */ "./src/bitap/bitap_search.js"
                                ),
                                s = i(
      ...
      \***********************************/
                        /*! no static exports found */ function (e, t, i) {
                            var n = i(
                                /*! ./is_array */ "./src/helpers/is_array.js"
                            );
                            e.exports = function (e, t) {
      ...
      \**********************/
                        /*! no static exports found */ function (e, t, i) {
                            ...
                            var r = i(/*! ./bitap */ "./src/bitap/index.js"),
                                ...
                                a = i(
                                    /*! ./helpers/is_array */ "./src/helpers/is_array.js"
                                ),
                                c = (function () {
                                    function e(t, i) {
                                        var n = i.location,
            ...
            var u = (0, n.combineReducers)({
                ...
                h = function (e, t) {
                    ...
                    if ("CLEAR_ALL" === t.type) i = void 0;
                        ...
                        return (0, c.cloneObject)(t.state);
                    return u(i, t);
                };
            t.default = h;
        },
                        ...
                        },
                        {
                            ...
                            value: function () {
                                this.element.removeEventListener(
                                    ...
                                    this.element.form &&
                                        this.element.form.removeEventListener(
                                            "reset",
                                            this._onFormReset
                                        );
                            },
                            ...
                            value: function (e) {
                                ...
                                if (this._placeholderValue) {
                                    var n =
                                        ...
                                        this._placeholderValue.length / 1.25;
                                    ((this.element.value && n) || e) &&
                                        this.calcWidth(i);
                        ...
                        },
                        {
                            ...
                            value: function (e, t, i) {
                                var o = this,
                                    ...
                                    a = !1;
                                i > 0
                                    ? (this._scrollDown(s, r, t),
                                      s < t && (a = !0))
                                    : (this._scrollUp(s, r, t),
                                      s > t && (a = !0)),
                                    a &&
                                        requestAnimationFrame(function () {
            ...
            var h = (function (e) {
                function t(e) {
                    ...
                    return (
                        ...
                        ((i = a(
                            this,
                            l(t).call(this, { element: n, classNames: o })
                        )).delimiter = r),
                        i
                    );
                }
